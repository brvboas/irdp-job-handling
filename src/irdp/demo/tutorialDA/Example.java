...
import irdp.protocols.tutorialDA.job.PrintApplicationLayer;
import irdp.protocols.tutorialDA.job.PrintLayer;
import irdp.protocols.tutorialDA.job.UpperPrintLayer;
...
public class Example {
  ...
  public static void main(String[] args) {
    ...
    Layer[] qos = {new PrintLayer(), new UpperPrintLayer(),
